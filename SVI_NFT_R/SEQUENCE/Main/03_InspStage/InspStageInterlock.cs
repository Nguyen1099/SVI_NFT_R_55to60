...
namespace SVI_NFT_R
{
    public class InspStageInterlock : CProcessInterlockAbstract
    {
        /// <summary>
        /// 생성자 함수
        /// </summary>
        /// <param name="objDocument">CDocument의 객체</param>
        public InspStageInterlock(CDocument objDocument)
        {
        ...
        public override bool Initialize()
        {
            ...
            do
            {
                m_objAlarmStructure.strAlarmObject = typeof(InspStageInterlock).Name;
