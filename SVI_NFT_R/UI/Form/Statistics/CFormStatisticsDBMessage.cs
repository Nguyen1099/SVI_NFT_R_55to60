...
namespace SVI_NFT_R
{
    public partial class CFormStatisticsDBMessage : CFormCommon, CFormInterface
    {
        /// <summary>
        /// 도큐먼트
        /// </summary>
        ...
        /// 현재 선택 메뉴
        /// </summary>
        private CDefine.EStatisticsDBMessage m_eCurrentStatisticsDB = CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_OP_CALL;
        /// <summary>
        /// 현재 매니저 테이블
        /// </summary>
        ...
        /// <returns></returns>
        public CFormStatisticsDBMessage(CDocument objDocument)
        {
            // 도큐먼트 포인트 받음
        ...
        /// <param name="e"></param>
        private void CFormStatisticsDBMessage_Load(object sender, EventArgs e)
        {
            // 초기화
            Initialize();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CFormStatisticsDBMessage_FormClosed(object sender, FormClosedEventArgs e)
        {
            // 해제
            DeInitialize();
        }
        ...
        public bool InitializeForm()
        {
            ...
            do
            {
                ...
                int iMenuCount = (int)CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_FINAL;
                // 버튼 여백 & 넓이 설정
                int iWhiteSpace = 2;
                ...
                {
                    strButtonName[iLoopButton] = ((CDefine.EStatisticsDBMessage)iLoopButton).ToString();
                }
                // 버튼 동적 생성
                ...
                {
                    m_btnMenu[iLoopMenu].Name = string.Format("BtnStatisticsDBMessage[{0}]", iLoopMenu);
                }
        ...
        public bool SetChangeLanguage()
        {
            ...
            do
            {
                ...
                SetDatabaseConnect(CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_OP_CALL, this.DateTimeFrom.Value, this.DateTimeTo.Value);
                // DB 리스트 그리드 뷰 초기화
        ...
        private new bool InitializeGridView(DataGridView objGridView)
        {
            ...
            do
            {
                ...
                {
                    case CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_OP_CALL:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryOPCall.DATE].Width = 153;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryOPCall.ID].Width = (int)(objGridView.Width * 0.08);
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryOPCall.MESSAGE].Width = 995;


                        break;
                    case CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_INTERLOCK_CALL:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryInterlockCall.DATE].Width = 153;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryInterlockCall.ID].Width = (int)(objGridView.Width * 0.08);
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryInterlockCall.MESSAGE].Width = 995;
                        break;
                    case CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_TERMINAL_CALL:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryTerminalCall.DATE].Width = 153;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryTerminalCall.ID].Width = (int)(objGridView.Width * 0.08);
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryTerminalCall.MESSAGE].Width = 995;
                        break;
                    default:
                        break;
                }
        ...
        private void SetDatabaseConnect(CDefine.EStatisticsDBMessage eStatisticsDB, DateTime objFrom, DateTime objTo)
        {
            // 디폴트 내림차순
        ...
        private void SetDatabaseConnect(CDefine.EStatisticsDBMessage eStatisticsDB, DateTime objFrom, DateTime objTo, string strOrder)
        {
            ...
            {
                case CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_OP_CALL:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryOPCall;
                    iIndexDate = (int)CDatabaseDefine.EHistoryOPCall.DATE;
                    break;
                case CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_INTERLOCK_CALL:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryInterlockCall;
                    iIndexDate = (int)CDatabaseDefine.EHistoryInterlockCall.DATE;
                    break;
                case CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_TERMINAL_CALL:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryTerminalCall;
                    iIndexDate = (int)CDatabaseDefine.EHistoryTerminalCall.DATE;
                    break;
                default:
                    break;
            }
        ...
        public void ButtonMenu_Click(object sender, EventArgs e)
        {
            ...
            CDefine.EStatisticsDBMessage eStatisticsDB = 0;
            try
            {
                ...
                if (true == objRegex.IsMatch(objButton.Name))
                {
                    ...
                    eStatisticsDB = (CDefine.EStatisticsDBMessage)Convert.ToInt32(strText);
        ...
        {
            for (int iLoopMenu = 0; iLoopMenu < (int)CDefine.EStatisticsDBMessage.STATISTICS_DB_MESSAGE_FINAL; iLoopMenu++)
            {
        ...
        private void BtnSelectAsc_Click(object sender, EventArgs e)
        {
            ...
            InitializeGridView(this.GridViewList);
            // 버튼 로그 추가
            string strLog = string.Format("[{0}] [Table : {1}] [From : {2}] [To : {3}]", "BtnSelect_Click", m_eCurrentStatisticsDB.ToString(), this.DateTimeFrom.Value.ToString(CDatabaseDefine.DEF_DATE_FORMAT), this.DateTimeTo.Value.ToString(CDatabaseDefine.DEF_DATE_FORMAT));
            m_objDocument.SetUpdateButtonLog(this, strLog);
        }
