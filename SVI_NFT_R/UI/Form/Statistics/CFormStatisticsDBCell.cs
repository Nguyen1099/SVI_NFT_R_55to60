...
namespace SVI_NFT_R
{
    public partial class CFormStatisticsDBCell : CFormCommon, CFormInterface
    {
        /// <summary>
        /// 도큐먼트
        /// </summary>
        ...
        /// 현재 선택 메뉴
        /// </summary>
        private CDefine.EStatisticsDBCell m_eCurrentStatisticsDB = CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_INPUT;
        /// <summary>
        /// 현재 매니저 테이블
        /// </summary>
        ...
        /// <returns></returns>
        public CFormStatisticsDBCell(CDocument objDocument)
        {
            // 도큐먼트 포인트 받음
        ...
        /// <param name="e"></param>
        private void CFormStatisticsDBCell_Load(object sender, EventArgs e)
        {
            // 초기화
            Initialize();
        }
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CFormStatisticsDBCell_FormClosed(object sender, FormClosedEventArgs e)
        {
            // 해제
            DeInitialize();
        }
        ...
        public bool InitializeForm()
        {
            ...
            do
            {
                ...
                int iMenuCount = (int)CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_FINAL;
                // 버튼 여백 & 넓이 설정
                int iWhiteSpace = 2;
                ...
                {
                    strButtonName[iLoopButton] = ((CDefine.EStatisticsDBCell)iLoopButton).ToString();
                }
                // 버튼 동적 생성
                ...
                {
                    m_btnMenu[iLoopMenu].Name = string.Format("BtnStatisticsDBCell[{0}]", iLoopMenu);
                }
        ...
        private new bool InitializeGridView(DataGridView objGridView)
        {
            ...
            do
            {
                ...
                {
                    case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_INPUT:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellInput.DATE].Width = 150;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellInput.INNER_ID].Width = 200;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellInput.CELL_ID].Width = 0;
                        break;
                    case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_OUTPUT:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellOutput.DATE].Width = 150;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellOutput.INNER_ID].Width = 200;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellOutput.CELL_ID].Width = 270;
                        break;
                    case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_TRACK_IN:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellTrackIn.DATE].Width = 150;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellTrackIn.INNER_ID].Width = 200;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellTrackIn.CELL_ID].Width = 270;
                        break;
                    case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_TRACK_OUT:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellTrackOut.DATE].Width = 150;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellTrackOut.INNER_ID].Width = 200;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryCellTrackOut.CELL_ID].Width = 270;
                        break;
                    case CDefine.EStatisticsDBCell.STATISTICS_DB_MCR_STATUS:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryMCRStatus.DATE].Width = 150;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryMCRStatus.MCR_ID].Width = 270;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryMCRStatus.RESULT].Width = 50;
                        break;
                    case CDefine.EStatisticsDBCell.STATISTICS_DB_MACHINE_RESULT:
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryMachineResult.DATE].Width = 150;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryMachineResult.INNER_ID].Width = 200;
                        objGridView.Columns[(int)CDatabaseDefine.EHistoryMachineResult.RESULT].Width = 50;
                        break;
                    default:
                        break;
                }
        ...
        private void SetDatabaseConnect(CDefine.EStatisticsDBCell eStatisticsDB, DateTime objFrom, DateTime objTo)
        {
            // 디폴트 내림차순
        ...
        private void SetDatabaseConnect(CDefine.EStatisticsDBCell eStatisticsDB, DateTime objFrom, DateTime objTo, string strOrder)
        {
            ...
            {
                case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_INPUT:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryCellInput;
                    iIndexDate = (int)CDatabaseDefine.EHistoryCellInput.DATE;
                    break;
                case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_OUTPUT:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryCellOutput;
                    iIndexDate = (int)CDatabaseDefine.EHistoryCellOutput.DATE;
                    break;
                case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_TRACK_IN:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryCellTrackIn;
                    iIndexDate = (int)CDatabaseDefine.EHistoryCellTrackIn.DATE;
                    break;
                case CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_TRACK_OUT:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryCellTrackOut;
                    iIndexDate = (int)CDatabaseDefine.EHistoryCellTrackOut.DATE;
                    break;
                case CDefine.EStatisticsDBCell.STATISTICS_DB_MCR_STATUS:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryMCRStatus;
                    iIndexDate = (int)CDatabaseDefine.EHistoryMCRStatus.DATE;
                    break;
                case CDefine.EStatisticsDBCell.STATISTICS_DB_MACHINE_RESULT:
                    m_objManagerTable = m_objDocument.m_objProcessDatabase.m_objProcessDatabaseHistory.m_objManagerTableHistoryMachineResult;
                    iIndexDate = (int)CDatabaseDefine.EHistoryMachineResult.DATE;
                    break;
                default:
                    break;
            }
        ...
        public void ButtonMenu_Click(object sender, EventArgs e)
        {
            ...
            CDefine.EStatisticsDBCell eStatisticsDB = 0;
            try
            {
                ...
                if (true == objRegex.IsMatch(objButton.Name))
                {
                    ...
                    eStatisticsDB = (CDefine.EStatisticsDBCell)Convert.ToInt32(strText);
        ...
        {
            for (int iLoopMenu = 0; iLoopMenu < (int)CDefine.EStatisticsDBCell.STATISTICS_DB_CELL_FINAL; iLoopMenu++)
            {
