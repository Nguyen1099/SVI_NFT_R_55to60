...
namespace SVI_NFT_R.DEVICE.Svi
{
    public static partial class ExtentionMethods
    {
        ...
        public static bool TryParseTotalResultDataForCG(this HLDevice.CDeviceSviInterface.CReceiveData packet, out ReceiveData.TotalResultDataForCG totalResultDataOrNull)
        {
            ...
            do
            {
                ...
                totalResultDataOrNull = new ReceiveData.TotalResultDataForCG();
