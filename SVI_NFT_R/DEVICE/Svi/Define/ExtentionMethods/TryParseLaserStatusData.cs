...
namespace SVI_NFT_R.DEVICE.Svi
{
    public static partial class ExtentionMethods
    {
        ...
        public static bool TryParseLaserStatusData(this HLDevice.CDeviceSviInterface.CReceiveData packet, out EPower laserStatus)
        {
            // OTM.SEND.LASER.[ON, OFF]
            bool bResult = false;
            laserStatus = 0;
            do
            {
                if (HLDevice.CDeviceSviInterface.EReceiveDataType.LaserStatusDataRequest != packet.eReceiveData)
                {
