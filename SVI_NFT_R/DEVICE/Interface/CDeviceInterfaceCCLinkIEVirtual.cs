using HLDeviceDLL.Interface.Melsec;
using System.Collections.Generic;

namespace HLDevice.Interface
{
    public class CDeviceInterfaceCCLinkIEVirtual : Abstract.CDeviceInterfaceAbstract
    {
        private readonly CInterfaceError m_objError = new CInterfaceError();
        private readonly CDeviceInterfaceMelsecVirtual m_objInterface = new CDeviceInterfaceMelsecVirtual();
        ...
        {
            CDeviceInterfaceMelsecVirtualDefine.CInitializeParameter objParameter = GetInitializeParameter(objInitializeParameter);
        ...
        private CDeviceInterfaceMelsecVirtualDefine.CInitializeParameter GetInitializeParameter(CInitializeParameter objInitializeParameter)
        {
            CDeviceInterfaceMelsecVirtualDefine.CInitializeParameter objParameter = new CDeviceInterfaceMelsecVirtualDefine.CInitializeParameter();
            objParameter.strMelsecChannel = objInitializeParameter.strInterfaceChannel;
            objParameter.strMelsecNetworkNumber = objInitializeParameter.strInterfaceNetworkNumber;
            objParameter.strMelsecStationNumber = objInitializeParameter.strInterfaceStationNumber;
            ...
            {
                CDeviceInterfaceMelsecVirtualDefine.CMelsecParameter objMelsecParameter = new CDeviceInterfaceMelsecVirtualDefine.CMelsecParameter();

                objMelsecParameter.eDataType = (CDeviceInterfaceMelsecVirtualDefine.enumDataType)item.Value.eDataType;
                ...
                objParameter.objMelsecParameterDigital.Add(item.Key.ToString(), objMelsecParameter);
            }
            ...
            foreach (KeyValuePair<string, CInitializeParameter.CInterfaceParameter> item in objInitializeParameter.objInterfaceParameterAnalog)
            {
                ...
                objParameter.objMelsecParameterAnalog.Add(item.Key.ToString(), objMelsecParameter);
            }
            return objParameter;
        }
        ...
        {
            CDeviceInterfaceMelsecVirtualDefine.CMelsecError objError = m_objInterface.HLGetErrorCode();
