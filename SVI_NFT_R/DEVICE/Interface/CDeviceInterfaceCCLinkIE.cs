...
{
    public class CDeviceInterfaceCCLinkIE : Abstract.CDeviceInterfaceAbstract
    {
        private readonly CInterfaceError m_objError = new CInterfaceError();
        private readonly HLDeviceInterfaceMelsec m_objInterface = new HLDeviceInterfaceMelsec();
        ...
        {
            CDeviceInterfaceMelsecDefine.CInitializeParameter objParameter = GetInitializeParameter(objInitializeParameter);
        ...
        private CDeviceInterfaceMelsecDefine.CInitializeParameter GetInitializeParameter(CInitializeParameter objInitializeParameter)
        {
            CDeviceInterfaceMelsecDefine.CInitializeParameter objParameter = new CDeviceInterfaceMelsecDefine.CInitializeParameter();
            ...
            {
                CDeviceInterfaceMelsecDefine.CMelsecParameter objMelsecParameter = new CDeviceInterfaceMelsecDefine.CMelsecParameter();

                objMelsecParameter.eDataType = (CDeviceInterfaceMelsecDefine.enumDataType)item.Value.eDataType;
        ...
        {
            CDeviceInterfaceMelsecDefine.CMelsecError objError = m_objInterface.HLGetErrorCode();
