...
{
    public class CDeviceMotorAjin : CDeviceMotorAbstract
    {
        /// <summary>
        /// 모터 포지션 객체 생성
        /// </summary>
        ...
        /// 모터 객체 선언
        /// </summary>
        public HLDeviceDLL.Motor.Ajin.CDeviceMotorAjin m_objMotorAjin;

        public override int OverrideSpeedRate
        {
            get
            {
                return m_objMotorAjin.OverrideSpeedRate;
            }
            set
            {
                m_objMotorAjin.OverrideSpeedRate = value;
            }
        }
        ...
        public override bool HLInitialize(CDeviceMotorAbstract.CMotorInitializeParameter objInitializeParameter)
        {
            ...
            {
                // 모터 객체 초기화
                m_objMotorAjin = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjin();

                // 모터 초기화 객체 생성
                HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorInitializeParameter objInitializeParameterDLL = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorInitializeParameter();
                ...
                if (false == m_objMotorAjin.HLInitialize(objInitializeParameterDLL))
                {
                    break;
                }
        ...
        {
            return m_objMotorAjin.GetVersion();
        }
        ...
        public override bool HLAlarmReset()
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLAlarmReset())
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override CDeviceMotorAbstract.EPositionCompare HLGetCompareTargetPosition(double dPosition)
        {
            ...
            do
            {
                bReturn = m_objMotorAjin.HLGetCompareTargetPosition(dPosition);
                if (false == bReturn)
        ...
        public override CDeviceMotorAbstract.EPositionCompare HLGetCompareTargetPosition(double dStartPosition, double dPosition)
        {
            ...
            do
            {
                bReturn = m_objMotorAjin.HLGetCompareTargetPosition(dStartPosition, dPosition);
                if (false == bReturn)
                    ePositionCompare = CDeviceMotorAbstract.EPositionCompare.POSITION_COMPARE_UNEQUAL;
                else if (true == bReturn)
                    ePositionCompare = CDeviceMotorAbstract.EPositionCompare.POSITION_COMPARE_EQUAL;
        ...
        public override CDeviceMotorAbstract.EPositionCompare HLGetCompareTargetPosition(int iPositionIndex)
        {
            ...
            do
            {
                bReturn = m_objMotorAjin.HLGetCompareTargetPosition(iPositionIndex);
                if (false == bReturn)
                    ePositionCompare = CDeviceMotorAbstract.EPositionCompare.POSITION_COMPARE_UNEQUAL;
                else if (true == bReturn)
                    ePositionCompare = CDeviceMotorAbstract.EPositionCompare.POSITION_COMPARE_EQUAL;
        ...
        public override bool HLSetHomeProcess()
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLSetHomeProcess())
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLGetHomeProcessRate(ref int iHomeMainStepNo, ref int iHomeStepNo)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLGetHomeProcessRate(ref iHomeMainStepNumber, ref iHomeStepNumber))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLServoOn(CDeviceMotorAbstract.EUse eUse)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLServoOn((HLDeviceDLL.Motor.Ajin.AXT_USE)eUse))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetSoftwareLimit(CDeviceMotorAbstract.EUse eUse)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetSoftwareLimit((HLDeviceDLL.Motor.Ajin.AXT_USE)eUse))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetPositionZeroSet()
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetPositionZeroSet())
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetActualPosition(double dPosition)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetActualPosition(dPosition))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetUnitPerPulse(double dUnit, int iPulse)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetUnitPerPulse(dUnit, iPulse))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLGetUnitperPulse(ref double dUnit, ref int iPulse)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLGetUnitPerPulse(ref dUnit, ref iPulse))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLJogFastMove(CDeviceMotorAbstract.EMoveDirection eDirection)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLJogFastMove((HLDeviceDLL.Motor.Ajin.AXT_MOTION_MOVE_DIR)eDirection))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLJogSlowMove(CDeviceMotorAbstract.EMoveDirection eDirection)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLJogSlowMove((HLDeviceDLL.Motor.Ajin.AXT_MOTION_MOVE_DIR)eDirection))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveContinue(EMoveDirection eDirection, EVelocityMode eModeType, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveContinue((HLDeviceDLL.Motor.Ajin.AXT_MOTION_MOVE_DIR)eDirection, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveAbsoluteIndex(int iPositionIndex, EVelocityMode eModeType, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveAbsoluteIndex(iPositionIndex, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        {
            if (false == m_objMotorAjin.HLMoveAbsolutePosition(index, dPosition, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dVelocity, dAcceleration, dDeceleration))
            {
                m_objMotorAjin.HLGetMotorError();
                return false;
            }
        ...
        {
            if (false == m_objMotorAjin.HLMoveAbsolutePosition(dPosition, dVelocity, dAcceleration, dDeceleration))
            {
                m_objMotorAjin.HLGetMotorError();
                return false;
            }
        ...
        public override bool HLMoveRelativePosition(double dPosition, EVelocityMode eModeType, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveRelativePosition(dPosition, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveStop()
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveStop())
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveEStop()
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveEStop())
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        {
            bool bReturn = false;
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMultiMoveParameter[] objMotorMoveParameter = null;
            do
            {
                if (null != objMultiMoveParameter)
                {
                    objMotorMoveParameter = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMultiMoveParameter[objMultiMoveParameter.Length];
                    for (int iLoopCount = 0; iLoopCount < objMultiMoveParameter.Length; iLoopCount++)
                    {
                        objMotorMoveParameter[iLoopCount] = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMultiMoveParameter();
                        ...
                        objMotorMoveParameter[iLoopCount].objMotorAjin = ((HLDevice.Motor.CDeviceMotorAjin)((HLDevice.CDeviceMotor)objMultiMoveParameter[iLoopCount].objMotor).HLGetAbstractReference()).m_objMotorAjin;
                    }
                }

                if (false == m_objMotorAjin.HLMoveMultiAbsoluteIndex((HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, objMotorMoveParameter))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveMultiAbsolutePosition(EVelocityMode eModeType, CMultiMoveParameter[] objMultiMoveParameter)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveMultiAbsolutePosition((HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, objMotorMoveParameter))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveMultiRelativePositioin(EVelocityMode eModeType, CMultiMoveParameter[] objMultiMoveParameter)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveMultiRelativePositioin((HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, objMotorMoveParameter))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveLineAbsoluteIndex(EVelocityMode eModeType, CMultiMoveParameter[] objMultiMoveParameter)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveLineAbsoluteIndex((HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, objMotorMoveParameter))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveLineAbsolutePosition(EVelocityMode eModeType, CMultiMoveParameter[] objMultiMoveParameter)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveLineAbsolutePosition((HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, objMotorMoveParameter))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveLineRelativePosition(EVelocityMode eModeType, CMultiMoveParameter[] objMultiMoveParameter)
        {
            ...
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveLineRelativePosition((HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, objMotorMoveParameter))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        /// <returns></returns>
        public override bool HLMoveMultiStop(object[] objMotorAjin)
        {
            bool bReturn = false;
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjin[] objMotor = null;
            do
            {
                if (null != objMotorAjin)
                {
                    objMotor = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjin[objMotorAjin.Length];
                    for (int iLoopCount = 0; iLoopCount < objMotorAjin.Length; iLoopCount++)
                    {
                        objMotor[iLoopCount] = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjin();
                        objMotor[iLoopCount] = ((HLDevice.Motor.CDeviceMotorAjin)((HLDevice.CDeviceMotor)objMotorAjin[iLoopCount]).HLGetAbstractReference()).m_objMotorAjin;
                    }
                }

                if (false == m_objMotorAjin.HLMoveMultiStop(objMotor))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        /// <param name="objMotorAjin"></param>
        /// <returns></returns>
        public override bool HLMoveMultiEStop(object[] objMotorAjin)
        {
            bool bReturn = false;
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjin[] objMotor = null;
            do
            {
                ...
                if (false == m_objMotorAjin.HLMoveMultiEStop(objMotor))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLOverridePosition(double dOverridePosition)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLOverridePosition(dOverridePosition))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLOverrideMaxVelocity(double dMaxOverrideVelocity)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLOverrideMaxVelocity(dMaxOverrideVelocity))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLOverrideVelocity(double dOverrideVelocity)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLOverrideVelocity(dOverrideVelocity))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveOverrideAtIndex(int iPositionIndex, EVelocityMode eModeType, double dOverridePosition, double dOverrideVelocity, double dMaxOverrideVelocity, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveOverrideAtIndex(iPositionIndex, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dOverridePosition, dOverrideVelocity, dMaxOverrideVelocity, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveOverrideAtPosition(double dPosition, EVelocityMode eModeType, double dOverridePosition, double dOverrideVelocity, double dMaxOverrideVelocity, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveOverrideAtPosition(dPosition, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dOverridePosition, dOverrideVelocity, dMaxOverrideVelocity, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveMultiOverrideAtIndex(int iPositionIndex, EVelocityMode eModeType, double[] dOverridePosition, double[] dOverrideVelocity, double dMaxOverrideVelocity, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveMultiOverrideAtIndex(iPositionIndex, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dOverridePosition, dOverrideVelocity, dMaxOverrideVelocity, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLMoveMultiOverrideAtPosition(double dPosition, EVelocityMode eModeType, double[] dOverridePosition, double[] dOverrideVelocity, double dMaxOverrideVelocity, double dVelocity = 0, double dAcceleration = 0, double dDeceleration = 0)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLMoveMultiOverrideAtPosition(dPosition, (HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.enumVelocityMode)eModeType, dOverridePosition, dOverrideVelocity, dMaxOverrideVelocity, dVelocity, dAcceleration, dDeceleration))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetTriggerTime(double dTriggerTimeWidth)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetTriggerTime(dTriggerTimeWidth))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetTriggerTime(int iAxis, double dTriggerTimeWidth)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetTriggerTime(iAxis, dTriggerTimeWidth))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetTriggerBlock(double dStartPosition, double dEndPosition, double dPeriodPosition)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetTriggerBlock(dStartPosition, dEndPosition, dPeriodPosition))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetTriggerBlock(int iAxis, double dStartPosition, double dEndPosition, double dPeriodPosition)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetTriggerBlock(iAxis, dStartPosition, dEndPosition, dPeriodPosition))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSetTriggerBlockReset()
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLSetTriggerBlockReset())
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        {
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorError objMotorError = m_objMotorAjin.HLGetMotorError();
        ...
        {
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorPosition objMotorPosition = m_objMotorAjin.HLGetMotorPosition();
        ...
        {
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorOperationParameter objMotorOperationParameter = m_objMotorAjin.HLGetMotorOperationParameter();
            ...
            if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_MOVE_DIR.DIR_CCW == objMotorOperationParameter.eHomeDirection)
            {
            ...
            if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.PosEndLimit == objMotorOperationParameter.eMotionHomeDetect)
            {
                m_objMotorOperationParameter.eHomeDetect = EHomeDetect.POS_END_LIMIT;
            }
            else if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.NegEndLimit == objMotorOperationParameter.eMotionHomeDetect)
            {
                m_objMotorOperationParameter.eHomeDetect = EHomeDetect.NEG_END_LIMIT;
            }
            else if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.HomeSensor == objMotorOperationParameter.eMotionHomeDetect)
            {
                m_objMotorOperationParameter.eHomeDetect = EHomeDetect.HOME_SENSOR;
            }
            else if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.EncodZPhase == objMotorOperationParameter.eMotionHomeDetect)
            {
                m_objMotorOperationParameter.eHomeDetect = EHomeDetect.ENCODER_Z_PHASE;
            }

            if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_LEVEL_MODE.LOW == objMotorOperationParameter.eMotionLevel)
            {
                m_objMotorOperationParameter.eMotionLevel = EMotionLevel.LEVEL_LOW;
            }
            else if (HLDeviceDLL.Motor.Ajin.AXT_MOTION_LEVEL_MODE.LOW == objMotorOperationParameter.eMotionLevel)
            {
        ...
        {
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorInitializeParameter objMotorInitializeParameter = m_objMotorAjin.HLGetMotorInitializeParameter();
        ...
        {
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorInitializeParameter objMotorInitializeParameter = new HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorInitializeParameter();
            ...
            m_objMotorAjin.HLSetMotorInitializeParameter(objMotorInitializeParameter);
        }
        ...
        {
            HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorStatus objMotorStatus = m_objMotorAjin.HLGetMotorStatus();
            m_objMotorStatus = new CMotorStatusFromFunction(
        ...
        public override bool HLWaitMotorStatus(object objMotor, EPositionCompare eCompareResult, int iTimeOut, int iSleepPeriod = 10)
        {
            ...
            if (EPositionCompare.POSITION_COMPARE_EQUAL == eCompareResult)
                ...
                bResult = false;
            return m_objMotorAjin.HLWaitMotorStatus(((HLDevice.Motor.CDeviceMotorAjin)((HLDevice.CDeviceMotor)objMotor).HLGetAbstractReference()).m_objMotorAjin, bResult, iTimeOut, iSleepPeriod);
        }
        ...
        public override bool HLWaitMotorPositionStatus(object objMotor, EPositionCompare eCompareResult, int iPositionIndex, int iTimeOut, int iSleepPeriod = 10)
        {
            ...
            if (EPositionCompare.POSITION_COMPARE_EQUAL == eCompareResult)
                ...
                bResult = false;
            return m_objMotorAjin.HLWaitMotorPositionStatus(((HLDevice.Motor.CDeviceMotorAjin)((HLDevice.CDeviceMotor)objMotor).HLGetAbstractReference()).m_objMotorAjin, bResult, iPositionIndex, iTimeOut, iSleepPeriod);
        }
        ...
        public override bool HLWaitMotorPositionStatus(object objMotor, EPositionCompare eCompareResult, double dStartPosition, double dPosition, int iTimeOut, int iSleepPeriod = 10)
        {
            ...
            if (EPositionCompare.POSITION_COMPARE_EQUAL == eCompareResult)
                ...
                bResult = false;
            return m_objMotorAjin.HLWaitMotorPositionStatus(((HLDevice.Motor.CDeviceMotorAjin)((HLDevice.CDeviceMotor)objMotor).HLGetAbstractReference()).m_objMotorAjin, bResult, dStartPosition, dPosition, iTimeOut, iSleepPeriod);
        }
        ...
        public override bool HLWaitMotorPositionStatus(object objMotor, EPositionCompare eCompareResult, double dPosition, int iTimeOut, int iSleepPeriod = 10)
        {
            ...
            if (EPositionCompare.POSITION_COMPARE_EQUAL == eCompareResult)
                ...
                bResult = false;
            return m_objMotorAjin.HLWaitMotorPositionStatus(((HLDevice.Motor.CDeviceMotorAjin)((HLDevice.CDeviceMotor)objMotor).HLGetAbstractReference()).m_objMotorAjin, bResult, dPosition, iTimeOut, iSleepPeriod);
        }
        ...
        public override bool HLLoadMotorOperationParameter(string strFilePath, string strModelName)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLLoadMotorOperationParameter(strFilePath, strModelName))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSaveMotorOperationParameter(string strFilePath, string strModelName, CMotorOperationParameter objMotorOperationParameter)
        {
            ...
            do
            {
                HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorOperationParameter objMotorOperationParameterDll = m_objMotorAjin.HLGetMotorOperationParameter();
                ...
                {
                    objMotorOperationParameterDll.eHomeDirection = HLDeviceDLL.Motor.Ajin.AXT_MOTION_MOVE_DIR.DIR_CCW;
                }
                else
                {
                    objMotorOperationParameterDll.eHomeDirection = HLDeviceDLL.Motor.Ajin.AXT_MOTION_MOVE_DIR.DIR_CW;
                }

                if (EHomeDetect.POS_END_LIMIT == objMotorOperationParameter.eHomeDetect)
                {
                    objMotorOperationParameterDll.eMotionHomeDetect = HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.PosEndLimit;
                }
                else if (EHomeDetect.NEG_END_LIMIT == objMotorOperationParameter.eHomeDetect)
                {
                    objMotorOperationParameterDll.eMotionHomeDetect = HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.NegEndLimit;
                }
                else if (EHomeDetect.HOME_SENSOR == objMotorOperationParameter.eHomeDetect)
                {
                    objMotorOperationParameterDll.eMotionHomeDetect = HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.HomeSensor;
                }
                else if (EHomeDetect.ENCODER_Z_PHASE == objMotorOperationParameter.eHomeDetect)
                {
                    objMotorOperationParameterDll.eMotionHomeDetect = HLDeviceDLL.Motor.Ajin.AXT_MOTION_HOME_DETECT.EncodZPhase;
                }

                if (EMotionLevel.LEVEL_LOW == objMotorOperationParameter.eMotionLevel)
                {
                    objMotorOperationParameterDll.eMotionLevel = HLDeviceDLL.Motor.Ajin.AXT_MOTION_LEVEL_MODE.LOW;
                }
                ...
                if (false == m_objMotorAjin.HLSaveMotorOperationParameter(strFilePath, strModelName, objMotorOperationParameterDll))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLLoadMotorPositionParameter(string strFilePath, string strModelName)
        {
            ...
            do
            {
                if (false == m_objMotorAjin.HLLoadMotorPositionParameter(strFilePath, strModelName))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        public override bool HLSaveMotorPositionParameter(string strFilePath, string strModelName, CMotorPosition objMotorPosition)
        {
            ...
            do
            {
                HLDeviceDLL.Motor.Ajin.CDeviceMotorAjinDefine.CMotorPosition objMotorPositionDll = m_objMotorAjin.HLGetMotorPosition();
                for (int iLoopCount = 0; iLoopCount < DEF_MAX_POSITION_COUNT; iLoopCount++)
                {
                ...
                if (false == m_objMotorAjin.HLSaveMotorPositionParameter(strFilePath, strModelName, objMotorPositionDll))
                {
                    m_objMotorAjin.HLGetMotorError();
                    break;
                }
        ...
        {
            return m_objMotorAjin.HLSetStatusRequestReadA5nWarningData();
        }
        ...
        {
            return m_objMotorAjin.HLGetStatusA5nWarningCode(ref warningCode);
        }
    }
}
