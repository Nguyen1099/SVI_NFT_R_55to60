...
namespace ENC.Data.Xml.Serialization
{
	...
	/// Must have a parameterless constructor and implement 
    /// </typeparam>
	public class XmlSerializer<T> where T : class, new()
    {
        ...
        public string Serialize(T source)
        {
            ...
            return Serialize(source, null, XmlSerializerHelper.IndentedSettings);
        }
        ...
        {
            // indented XML by default
            return Serialize(source, namespaces, XmlSerializerHelper.IndentedSettings);
        }
        ...
        {
            // indented XML by default
            SerializeToFile(source, filename, null, XmlSerializerHelper.IndentedSettings);
        }
        ...
        {
            // indented XML by default
            SerializeToFile(source, filename, namespaces, XmlSerializerHelper.IndentedSettings);
        }
        ...
        /// <param name="namespaces">Namespaces to include in serialization</param>
        /// <param name="settings">XML serialization settings. <see cref="System.Xml.XmlWriterSettings"/></param>
        public void SerializeToFile(T source, string filename, XmlSerializerNamespaces namespaces, XmlWriterSettings settings)
        {
            if (source == null)
            {
                throw new ArgumentNullException("source", "Object to serialize cannot be null");
