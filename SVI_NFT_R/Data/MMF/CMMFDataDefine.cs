...
/// </summary>
namespace ENC.MemoryMap.Define
{
    using System.IO;
    ...
    /// </summary>
    class MMData_PageBase : IDisposable
    {
        /// <summary>
        /// 메모리 맵 파일 클래스 입니다.
        /// </summary>
        ...
        /// 바이트형 데이터의 크기 입니다.
        /// </summary>
        public static readonly long ByteDataSize = 2048 * 1;        //=  2,048 byte
        /// <summary>
        /// 바이트형 데이터의 크기 입니다.
        /// </summary>
        ...
        /// 스트링형 데이터의 크기 입니다.
        /// </summary>
        public static readonly long StringDataSize = 1024 * 512 * 1; //= 65,536 byte
        /// <summary>
        /// 메모리 블럭 하나의 크기 입니다.
        /// </summary>
        public static readonly long PageSize = (2048 * 1) + (2048 * 1) + (512 * 2) + (512 * 4) + (512 * 4) + (512 * 8) + (1024 * 512 * 1); // = ByteDataSize + IntDataSize + FloatDataSize + DoubleDataSize + StringDataSize
        ...
        protected MMData_PageBase(MemoryMappedFile memMap, uint pageIndex, uint pageCount)
        {
            // 메모리 맵 파일을 엽니다.
            _memMap = memMap;
        ...
        public void Copy(MMData_PageBase sourceData)
        {
