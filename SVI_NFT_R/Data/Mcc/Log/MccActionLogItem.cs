...
namespace Mcc
{
    public sealed class MccActionLogItem : IMccLogItem
    {
        ...
        public MccActionLogItem(CDocument document, EProcess process, int position, string actionNamePrefix, string actionName, string moduleID, string fromPosition, string toPosition)
        {
            mDocument = document;
            mProcess = process;
            mPosition = position;
        ...
        public MccActionLogItem(CDocument document, string actionNamePrefix, string actionName, string moduleID, string fromPosition, string toPosition)
        {
            mDocument = document;
            mProcess = 0;
            mPosition = 0;
